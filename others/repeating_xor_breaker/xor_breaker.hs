...
main :: IO ()
main = do
  enc <- decodeLenient <$> C8.readFile "enc.b64"

  C8.writeFile "decrypted" $ breakXOR enc
...
score = uncurry (+) . (letterScore &&& unprintableScore) . C8.unpack
  where
    ...
    charScores = IntMap.fromDistinctAscList . map (first C.ord) $ [ (' ', 0), ('a', 9), ('b', 2), ('c', 3), ('d', 5), ('e', 14), ('f', 3), ('g', 3), ('h', 7), ('i', 8), ('j', 1), ('k', 2), ('l', 5), ('m', 3), ('n', 8), ('o', 9), ('p', 3), ('q', 1), ('r', 7), ('s', 7), ('t', 11), ('u', 4), ('v', 2), ('w', 4), ('x', 1), ('y', 3), ('z', 1) ]
